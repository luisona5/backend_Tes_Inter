...
const sendMailToRecoveryPasswordEstudiante = (userMail, token) => {
    
    const recoveryLink = `${process.env.VITE_URL_FRONTEND}reset/estudiante/${token}`;
...
export { sendMailToRecoveryPasswordEstudiante };